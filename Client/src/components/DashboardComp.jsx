...
const DashboardComponent = () => {
  ...
  console.log(totlaPosts);

  return (
    <div className="md:mx-auto w-full justify-between p-10">
        ...
        >
          <div className="flex justify-between">
            <div className="">
              ...
              <p className="text-2xl">{totlaPosts}</p>
            </div>
            <HiOutlineUserGroup className="bg-teal-600 text-white rounded-full text-5xl p-3 shadow-lg" />
          </div>
          <div className="flex gap-2 text-sm">
      ...
      <div className="flex flex-wrap gap-16 my-5 py-3 mx-auto justify-center">
                ...
                <Table.Body key={comment._id} className="divide-y">
                  <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800 ">
                    <Table.Cell className="w-96">
                      <p className="line-clmp-2">{comment.content}</p>
                    </Table.Cell>
